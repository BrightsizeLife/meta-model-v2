...
- 80 columns: 5 identifiers + 2 scores + 72 offensive/defensive stats + last_met_date
...
- 84 columns: all 80 from game_stats.csv + 4 metadata fields (kickoff_time, stadium, day, time)
